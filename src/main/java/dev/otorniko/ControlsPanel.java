...
/**
 * Luokka, joka esittää käyttöliittymän ohjauspaneelin, jossa käyttäjä voi
 * valita erityisruokavalion, järjestämis- ja suodatusvaihtoehdot.
 */
public class ControlsPanel extends JPanel {
    ...
    /**
     * Alustaa ControlsPanelin komponentit, mukaan lukien ruokavalio- ja
     * suodatusvaihtoehdot.
     */
    ...
    public String getSelectedDietOption() {
        if (rbVeg != null && rbVeg.isSelected())
            return "Kasvis";
        if (rbVegan != null && rbVegan.isSelected())
            return "Vegaani";
        return "Ei ole";
    }
    ...
    public boolean isNopeatFilterActive() { return nopeatButton != null && nopeatButton.isSelected(); }

    public boolean isHelpotFilterActive() { return helpotButton != null && helpotButton.isSelected(); }
    ...
    /**
     * Lisää toimintakuuntelijan ohjauskomponenteille muutosten havaitsemiseksi.
     *
     * @param listener Lisättävä toimintakuuntelija.
     */
    public void addControlChangeListener(ActionListener listener) {
        // Diet Radio Buttons
        if (rbNone != null)
            rbNone.addActionListener(listener);
        if (rbVeg != null)
            rbVeg.addActionListener(listener);
        if (rbVegan != null)
            rbVegan.addActionListener(listener);
        ...
        if (nopeatButton != null)
            nopeatButton.addActionListener(listener);
        if (helpotButton != null)
            helpotButton.addActionListener(listener);
    ...
    private void showHelpDialog() {
        String helpMessage = "<html>" + "<b>Perusohjeet:</b><br>" + "1. Valitse raaka-aineita listasta<br>"
                + "2. Selaa löytyneitä reseptejä<br>" + "3. Klikkaa reseptiä nähdäksesi ohjeet<br><br>"
                + "<b>Vinkki:</b> Voit järjestää ja suodattaa listaa yläpalkin valinnoilla.<br>" + "</html>";

        JOptionPane.showMessageDialog(this, helpMessage, "Käyttöohje", JOptionPane.INFORMATION_MESSAGE);
    }
}
...
public class RecipeData {
    ...
    public RecipeData(String name, List<String> ingredients, int timeMinutes, int portions,
            List<String> erityisruokavalio, List<String> steps) {
        this.name = name;
    ...
    @Override
    public String toString() { return "RecipeData{" + "name='" + name + '\'' + '}'; }
}
